...
export class I8080Ops extends I8080Base {
  ...
  @inline _call(w16: u16): void {
    this._push(this.pc);
    this.pc = w16;
  }

  @inline ret(): void { this.pc = this._pop(); }
  ...
  @inline _push(v: u16): void {
    this.sp -= 2;
    this.memory_write_word(this.sp, v);
  }

  @inline rst(addr: u16): void {
    this._push(this.pc);
    this.pc = addr;
  }
  ...
  @inline mov(src: RegisterIdx, dst: RegisterIdx): void { this.set_reg(dst, this.reg(src)); }

  @inline mvi(r: RegisterIdx): void { this.set_reg(r, this.next_pc_byte()); }

  @inline inx(r: RegisterIdx): void { this.set_rp(r, this.rp(r) + 1); }
  ...
  @inline pchl(): void { this.pc = this.hl; }
  @inline sphl(): void { this.sp = this.hl; }

  @inline nop(): void {}

  @inline stax(rp: RegisterPairIdx): void { this.memory_write_byte(this.rp(rp), <u8>this.a); }

  @inline adi(): void { this.add_im8(this.next_pc_byte(), 0); }
  @inline aci(): void { this.add_im8(this.next_pc_byte(), this.cf); }

  @inline ani(): void { this.ana_im8(this.next_pc_byte()); }
  @inline xri(): void { this.xra_im8(this.next_pc_byte()); }
  @inline ori(): void { this.ora_im8(this.next_pc_byte()); }
  @inline cpi(): void { this.cmp_im8(this.next_pc_byte()); }

  @inline sui(): void { this.sub_im8(this.next_pc_byte(), 0); }
  @inline sbi(): void { this.sub_im8(this.next_pc_byte(), this.cf); }

  @inline lxi(rp: RegisterPairIdx): void { this.set_rp(rp, this.next_pc_word()); }
  ...
  @inline ldax(rp: RegisterPairIdx): void { this.a = (this.memory_read_byte(this.rp(rp))); }
  ...
  @inline cma(): void { this.a ^= 0xff; }

  @inline ldhl(): void {
    const w16 = this.next_pc_word();
    this.set_rp(Register.H, this.memory_read_word(w16));
  }

  @inline sta(): void  { this.memory_write_byte(this.next_pc_word(), <u8>this.a); }

  @inline stc(): void { this.cf = 1; }

  @inline lda(): void { this.a = (this.memory_read_byte(this.next_pc_word())); }

  @inline cmc(): void { this.cf = !this.cf; }

  @inline hlt(): void { this.pc--; }
  ...
  @inline push(rp: RegisterPairIdx): void {
    let w16 = rp != 6 ? this.rp(rp) : (<u16>this.a << 8) | this.store_flags();
    this._push(w16);
  }

  @inline pop(rp: RegisterPairIdx): void {
    let w16 = this._pop();
    if (rp != 6) {
      this.set_rp(rp, w16);
    } else {
  ...
  @inline call(): void  { this._call(this.next_pc_word()); }
}
