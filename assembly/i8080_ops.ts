...
export class I8080Ops extends I8080Base {
  ...
  @inline
  push_b(): void {
    this.push(Register.B);
  }

  @inline
  push_d(): void {
    this.push(Register.D);
  }

  @inline
  push_h(): void {
    this.push(Register.H);
  }

  @inline
  push_psw(): void {
    this.push(Register.M);
  }
  ...
  @inline
  ldax_b(): void {
    this.ldax(Register.B);
  }

  @inline
  ldax_d(): void {
    this.ldax(Register.D);
  }

  @inline
  stax_b(): void {
    this.stax(Register.B);
  }

  @inline
  stax_d(): void {
    this.stax(Register.D);
  }
}
